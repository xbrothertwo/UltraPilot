...
export function buildMissionControl(input: {
  ...
  const definitions = [
    ...
    { key: "weekend_500", title: "500-km-RAG-Wochenende", horizon: "2027/28", achieved: bestBackToBackKm >= 500, value: bestBackToBackKm, target: 500, evidence: `Bestwert ${bestBackToBackKm} km`, purpose: "Großer Haltbarkeitstest mit Support-, Schlaf- und Materialabläufen.", requirements: [requirement("400-km-Fahrt", longestRideKm >= 400), requirement("Erholungsdaten stabil erfasst", input.recoveryTrackedNights >= 21)] },
