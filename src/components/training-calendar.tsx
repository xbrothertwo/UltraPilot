...
import { formatHeartRateTarget, formatPaceTarget, getPlannedHeartRateTarget, getPlannedPaceTarget, type PaceZone, type ZoneDefinition } from "@/lib/training-zones";
...
export function TrainingCalendar({ primarySport, days, week, workouts, events, activities, heartRateZones, paceZones, readiness, activityLoads }: { primarySport: PrimarySport; days: string[]; week: string; workouts: PlannedWorkout[]; events: PlanningEvent[]; activities: Activity[]; heartRateZones: ZoneDefinition[] | null; paceZones: PaceZone[] | null; readiness: ReadinessResult[]; activityLoads: ActivityLoad[] }) {
