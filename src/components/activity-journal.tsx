    ...
    <section id="journal" className="mt-6 space-y-6 scroll-mt-24">
      <div className="card p-6">
        ...
        <dl className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl bg-blue-50/45 p-4"><dt className="text-xs text-[var(--muted)]">Flüssigkeit</dt><dd className="mt-1 text-xl font-bold">{summary.fluidMilliliters.toLocaleString("de-DE")} ml</dd><p className="text-xs text-[var(--muted)]">{summary.fluidPerHour.toLocaleString("de-DE", { maximumFractionDigits: 0 })} ml/h</p></div>
          <div className="rounded-2xl bg-blue-50/45 p-4"><dt className="text-xs text-[var(--muted)]">Natrium</dt><dd className="mt-1 text-xl font-bold">{summary.sodiumMilligrams.toLocaleString("de-DE")} mg</dd><p className="text-xs text-[var(--muted)]">{summary.sodiumPerHour.toLocaleString("de-DE", { maximumFractionDigits: 0 })} mg/h</p></div>
          <div className="rounded-2xl bg-blue-50/45 p-4"><dt className="text-xs text-[var(--muted)]">Energie</dt><dd className="mt-1 text-xl font-bold">{summary.calories.toLocaleString("de-DE")} kcal</dd><p className="text-xs text-[var(--muted)]">protokolliert</p></div>
        </dl>
