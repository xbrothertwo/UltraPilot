  ...
  return (
    <>
      ...
      <div className="card overflow-hidden">
        ...
        {activities.length ? activities.map((activity) => <Link key={activity.id} href={`/activities/${activity.id}`} className="grid gap-4 border-b border-[var(--line)] p-5 transition last:border-b-0 hover:bg-emerald-50/40 sm:grid-cols-[1fr_repeat(3,auto)] sm:items-center sm:gap-10">
