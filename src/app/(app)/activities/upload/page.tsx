...
import { preferredImportSport } from "@/lib/activity-import";
...
export default async function UploadPage({ searchParams }: Props) {
  ...
  const defaultSportType = preferredImportSport(planning.profile.selectedSports);
  return <>
    ...
    <UploadForm defaultSportType={defaultSportType} />
